...
def _reverse_image_search(image_url: str) -> dict:
    ...
    combined = {"amazon": [], "flipkart": [], "meesho": []}
    ...
    try:
        ...
        if asin_map:
            ...
            for c in candidates:
                ...
                if d is not None and cl is not None and d >= 0.70 and cl >= 0.75:
